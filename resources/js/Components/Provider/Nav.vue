...
const viewNotificationDetail = (notificationId) => {
    Inertia.get(route('provider.notification.show', notificationId));
};
</script>
                        ...
                        <div
                            ...
                            <ul class="py-1" role="none">
                                ...
                                <li>
                                    <Link
                                        :href="route('logout')"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" method="post"
